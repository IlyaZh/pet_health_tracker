...
public enum ReportCategory
{
    ...
    [Description("Все")] All = 1,

    [Description("🧼 Гигиена")] Hygiene = 2,

    [Description("💊 Медицина")] MedicalEvent = 3,
...
public enum HygieneEventType
{
    ...
    [Description("Стрижка когтей ✂️")] Nails = 1,

    [Description("Чистка желез 🍑")] Glands = 2,

    [Description("Чистка зубов 🦷")] Teeth = 3
}
...
public enum SymptomType
{
    ...
    [Description("Рвота 🤮")] Vomiting = 1,

    [Description("Диарея 💩")] Diarrhea = 2,

    [Description("Вялость 🥱")] Lethargy = 3,

    [Description("Отказ от еды 🥣🚫")] LossOfAppetite = 4,

    [Description("Хромота 🐾🩹")] Limping = 5,

    [Description("Зуд / Чес 🧼🐕")] Itching = 6,

    [Description("Другое ❓")] Other = 99
}
